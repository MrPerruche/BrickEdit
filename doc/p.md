...
| `UInteger24Meta`        | Integer from 0 to 16,777,215                      | 24-bit unsigned integer LE                                      | Commonly used for 3-channel colors.                               |
| `UInteger32Meta`        | Integer from 0 to 4,294,967,295                   | 32-bit unsigned integer LE                                      | Commonly used for 4-channel colors.                               |
|                         |                                                   |                                                                 |                                                                   |
...
Here is what a full implementation may look like:
